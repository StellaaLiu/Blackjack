...
from game.dealer import BlackjackDealer
from game.player import BlackjackPlayer
from game.judger import BlackjackJudger
...
class BlackjackGame:
    ...
    def init_game(self):
        ...
        '''
        self.dealer = BlackjackDealer(self.np_random, self.num_decks)

        self.players = []
        for i in range(self.num_players):
            self.players.append(BlackjackPlayer(i, self.np_random))
